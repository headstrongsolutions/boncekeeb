...
Keeb_Key keeb_keys[total_key_count] = {
    {0, 16, {0xff, 0x00, 0x00}, 0, 0, false, "ESC", 0},
    {1, 15, {0xff, 0x00, 0x00}, 0, 0, false, "F10", 0},
    {2,  8, {0xff, 0x00, 0x00}, 0, 0, false, "F9",  0},
    {3,  7, {0xff, 0x00, 0x00}, 0, 0, false, "F5",  0},
    {4,  0, {0xff, 0x00, 0x00}, 0, 0, false, "F6",  0},

    {5, 17, {0x00, 0xff, 0x00}, 0, 0, false, "[",   0},
    {6, 14, {0x00, 0xff, 0x00}, 0, 0, false, "]",   0},
    {7,  9, {0x00, 0xff, 0x00}, 0, 0, false, "T",   0},
    {8,  6, {0x00, 0xff, 0x00}, 0, 0, false, "O",   0},
    {9,  1, {0x00, 0xff, 0x00}, 0, 0, false, "I",   0},

    {10, 18, {0x00, 0x00, 0xff}, 0, 0, false, "L",  0},
    {11, 13, {0x00, 0x00, 0xff}, 0, 0, false, ";",  0},
    {12, 10, {0x00, 0x00, 0xff}, 0, 0, false, "H",  0},
    {13,  5, {0x00, 0x00, 0xff}, 0, 0, false, "W",  0},
    {14,  2, {0x00, 0x00, 0xff}, 0, 0, false, "E",  0},

    {15, 19, {0xff, 0xff, 0xff}, 0, 0, false, ".",  0},
    {16, 12, {0xff, 0xff, 0xff}, 0, 0, false, "\'", 0},
    {17, 11, {0xff, 0xff, 0xff}, 0, 0, false, "A",  0},
    {18,  4, {0xff, 0xff, 0xff}, 0, 0, false, "S",  0},
    {19,  3, {0xff, 0xff, 0xff}, 0, 0, false, "D",  0}
};
...
//     if (now_ms - start_ms < interval_ms) return false; // not enough time
